function  valiText(myfield, e, cadena){
    switch (cadena){
        caso 1:
            cadena1 = ""
    }
...
const validText = (this, event, a) =>{

}

const actas_bscarPrNmroMesa = async(form) => {
    const acta = form["nroMeza"].value;

    if(nroMeza == ""){
        alert("Ingresa un numero de acta");
        return
    }
    if(nroMeza){
        alert("Ingresa un numero de acta");
